...
export const zh_CN: TranslationMap = {
  ...
  subtitles: {
    ...
    usage: "API 使用情况和成本。",
    cron: "唤醒和重复运行。",
    cloudAuth: "登录、注册与邀请接受。",
    cloudProfile: "用户资料与工作区设置。",
    cloudMembers: "成员、角色与邀请链接。",
    cloudAccount: "云账户身份与状态。",
    cloudBilling: "余额、消耗、交易流水与充值订单 Mock。",
    cloudRelay: "Relay 端点、API Key 状态、模型与费率。",
    cloudReconciliation: "对比本地用量与云端 Relay 计费记录。",
    skills: "技能和 API 密钥。",
  ...
  login: {
    ...
    failure: {
      ...
      protocol: {
        ...
        stepRestart: "更新 ClawDesk 后重启 Gateway，使其提供当前协议。",
      },
      network: {
        title: "无法连接",
