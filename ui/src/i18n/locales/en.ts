...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    cloudAuth: "Login, registration, and invite acceptance.",
    cloudProfile: "User profile and workspace settings.",
    cloudMembers: "Members, roles, and invite links.",
    cloudAccount: "Cloud account identity and status.",
    cloudBilling: "Balance, spend, transactions, and recharge order mock.",
    cloudRelay: "Relay endpoint, API key state, models, and rates.",
    cloudReconciliation: "Compare local usage with cloud relay billing records.",
